...
There are two ways you could read this guide:

-   Read the whole thing and you will learn about threats and how to mitigate most of them (it's a very long read). If you go through with this long read including the many references, I believe you'll understand most of the current online privacy and anonymity issues.

-   Read the first chapters (Understanding some basics of how some information can lead back to you and how to mitigate those:) if you just want to learn about the threats to privacy and anonymity without necessarily applying the technical aspects. **It's about 26 pages until it gets really technical.**
