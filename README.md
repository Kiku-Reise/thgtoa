...
The latest version (**0.6.8**, See <https://anonymousplanet.github.io/thgtoa/CHANGELOG.html>) of the guide as well as the media files are also signed using GPG (see the .sig files).
